"""
    Copied from https://github.com/DavidMuller/aws-requests-auth/blob/master/aws_requests_auth/aws_auth.py
    On commit ID: c008d9e2520af47f4d425676075606134c016dea
"""
import hmac
import hashlib
import datetime
